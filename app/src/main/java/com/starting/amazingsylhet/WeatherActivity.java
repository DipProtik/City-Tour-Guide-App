...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1_temp = (TextView) findViewById(R.id.textView5);
    ...
    private void find_weather() {
        String url = "http://api.openweathermap.org/data/2.5/weather?q=sylhet,bangladesh&appid=af993902506e270591e09aa7427478f3&units=Imperial";
